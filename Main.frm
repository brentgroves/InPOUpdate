...
'*******************GET STANDARD TERMS FROM M2M VENDOOR PAGE***************
  ...
  If Not SkipPO Then
   ...
   DestinationRecordset.Fields("fpoclosing") = "Please reference our purchase order number on all correspondence.  Notification of changes regarding quantities to be shipped and changes in the delivery schedule are required." + Chr(13) + "PO APPROVALS:" + Chr(13) + "Requr. _______________________________________" + Chr(13) + "Dept. Head ___________________________________" + Chr(13) + "G.M. Only: All Items Over $500.00" + Chr(13) + "G.M ________________________________________" + Chr(13) + "VP/CFO. Only: All Assests/CER and ER Over $10000.00" + Chr(13) + "VP/CFO _____________________________________" + Chr(13) + "Pres. Only: All Assets/CER/ER and/or PO’s Over $10000.00" + Chr(13) + "President _____________________________________"
